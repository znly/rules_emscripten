...
filegroup(
    ...
    srcs = glob(["**"], exclude=["third_party/websockify/Windows/**", "site/**"]),
        ...
        strip_prefix = "emscripten-1.38.15",
    )
    _maybe(http_archive,
        name = 'emscripten_clang',
        url = 'https://s3.amazonaws.com/mozilla-games/emscripten/packages/llvm/tag/osx_64bit/emscripten-llvm-e1.38.15.tar.gz',
        build_file_content = _ALL_FILES_CONTENT,
        strip_prefix = "emscripten-llvm-e1.38.15",
